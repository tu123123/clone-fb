  ...
  return createPortal(
    <div className="Modal">
      <div className="modal-form">
        ...
        <div className="modal-footer">{groupButton}</div>
      </div>
    </div>,
  ...
  return (
    <Modal
      ...
      groupButton={
        dangky ? (
          <>
            <div onClick={() => setDangky(false)} className="dangky">
              Đăng nhập
            </div>
            <Button
              onClick={() => {
          ...
          <>
            <div onClick={() => setDangky(true)} className="dangky">
              Đăng ký
            </div>
            <Button
              onClick={() => {
                ...
                getData2(
                  ...
                  and(
                    ...
                    where("password", "==", userLogin.password)
                  )
                );
              }}
              style={{
